                                                    ...
                                                    <Card className="bg-gray-800/50 border-gray-700">
                                                        <CardHeader className="pb-3">
                                                            <CardTitle className="text-gray-200 flex items-center gap-2">
                                                                ...
                                                                Video Resources ({videosToShow.length})
                                                            </CardTitle>
                                                        </CardHeader>
                                                        <CardContent>
                                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                                {videosToShow.map((video, idx) => {
                                                                    ...
                                                                    return (
                                                                        <div key={idx} className="bg-gray-900/70 border border-gray-700 rounded-xl overflow-hidden shadow-sm">
                                                                            ...
                                                                            {(video.title || video.channel) && (
                                                                                <div className="px-3 py-2 border-t border-gray-700">
                                                                                    {video.title && <div className="text-sm text-gray-100 line-clamp-2 mb-1">{video.title}</div>}
                ...
                >
                    <div className={`flex ${isMultiline ? 'items-end' : 'items-center'} gap-3`}>
                        ...
                        <motion.button
                            ...
                            className="bg-blue-600 rounded-full hover:bg-blue-700 disabled:bg-gray-600 text-white p-3 transition-colors duration-200 disabled:cursor-not-allowed cursor-pointer focus:outline-none focus:ring-0"
                        >
                            {isProcessing ? (
